...
export const begin = {
  ...
  execute: async (message) => {
    logger.debug('Begin command received', {
    ...
    if (game.startGame()) {
      ...
      const firstPlayer = game.players.get(game.currentTurn);
      const gameStartEmbed = new EmbedBuilder()
        ...
        .addFields(
          ...
          {
            name: '❤️ Starting Health',
            value: `${firstPlayer.health}`,
            inline: true
          },
          {
            name: '🎴 Hand Size',
            value: `${firstPlayer.hand.length}`,
            inline: true
          }
        );
      ...
      logger.info('Game started successfully', {
        ...
        firstPlayer: firstPlayer.user.tag
      });
    }
  }
};